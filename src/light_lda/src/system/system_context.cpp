...
int32_t GlobalContext::num_io_threads_ = 1;
...
int32_t GlobalContext::num_vocabs_;
int32_t GlobalContext::num_topics_;
//int32_t GlobalContext::slice_size_;
std::string GlobalContext::meta_name_;
std::string GlobalContext::dump_file_;
int32_t GlobalContext::dump_iter_;
