...
# Parameters
params = {
    # Start running or not
    'start': True
    , 'shared_file_system': True

    # Input files:
    , 'word_id_file': '/home/yuntiand/daiwei/wrapup_preprocess/lightlda/datasets/word_dict.id.txt.20news' # Synced at Sat, 25 Apr 2015 03:30:01 GMT
    , 'host_filename': 'scripts/localserver'
    , 'binary_doc_dir': '/home/yuntiand/daiwei/wrapup_preprocess/lightlda/datasets/binary_doc_dir' # Synced at Sat, 25 Apr 2015 03:30:01 GMT
    ...
    # Default parameters:
    , 'block_offset': 0 # Synced at Sat, 25 Apr 2015 03:30:01 GMT
    , 'mh_step': 2
    , 'load_factor': 2
}
...
if __name__ == '__main__':
    ...
    print('Creating directories if not present on local machine')
    need_mkdirs = [os.path.dirname(params['dict_meta_file']), params['log_dirname']]
